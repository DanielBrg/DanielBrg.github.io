...
function pmc_breadcrumb($title = false) {
	...
	if (!is_home()) {
		...
		elseif(get_query_var('portfoliocategory')){
			...
			$breadcrumb .= __('Resultados para ', 'pmc-themes') .'"<span>'.get_search_query().'</span>"';			
...
function pmc_add_portfolio(){
	...
	add_meta_box("portfolio_details", "Configurações do Portifólio", "pmc_portfolio_options", $port, "normal", "high");
    ...
    <div id="portfolio-options">
        ...
        <table cellpadding="15" cellspacing="15">
        	...
        	<tr>
                ...
                <td colspan="2"><strong>Opções do Portifólio:</strong></td>
            ...
            <!--<tr>
            	...
            	<td><label> Link: <i style="color: #999999;">(The URL of your project)</i></label></td><td><input name="website_url" style="width:100%" value="<?php echo $website_url; ?>" /></td>

            </tr>-->

            <tr>

            	<td><label>Garantia: <i style="color: #999999;">(Tempo de Garantia)</i></label></td><td><input name="author" style="width:100%" value="<?php echo $author; ?>" /></td>

            </tr>

            <tr>

            	<td><label>Linha: <i style="color: #999999;">(Premium, Padrão)</i></label></td><td><input name="date" style="width:100%" value="<?php echo $date; ?>" /></td>

            </tr>	

            <tr>

            	<td><label>Fabricante: </label></td><td><input name="customer" style="width:100%" value="<?php echo $customer; ?>" /></td>
            ...
            <tr>
            	...
            	<td><label>Diferenciais: <i style="color: #999999;">(Diferenciais do Produto)</i></label></td><td><textarea name="skils" style="width:100%; height:300px;" /><?php echo $skils; ?></textarea></td>
    ...
    <div id="portfolio-options-video">
        ...
        <table cellpadding="15" cellspacing="15">
        	...
        	<tr>
                ...
                <td colspan="2"><strong>Opções para vídeo:</strong></td>

            </tr>

            <tr>

                <td><label>Exibir vídeo ao invés de imagens: <i style="color: #999999;">(O vídeo substituirá as imagens!)</i></label></td><td><input type="checkbox" name="show_video" value="1" <?php if( isset($show_video)){ checked( '1', $pmc_data["show_video"][0] ); } ?> /></td>	

            </tr>

            <tr>

            	<td><label>URL do Vídeo:</label></td><td><input name="video" style="width:100%" value="<?php echo $video; ?>" /></td>
