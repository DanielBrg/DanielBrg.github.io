	...
	<div class="content fullwidth">
		<div class="blogpost postcontent port" >
					...
					<p>
						<div class = "project-section">
							<?php if($portfolio['customer'][0] !='') {?>
								<!--<i class="fa fa-user"></i>--><?php _e('Fabrica&ccedil;&atilde;o','pmc-themes'); ?> <span class="author port"><?php echo $portfolio['customer'][0] ?></span><br>
							<?php } ?>
						</div>
						
						<div class = "project-section">
							<?php if($portfolio['date'][0] !='') {?>
								<!--<i class="fa fa-calendar"></i>--><?php _e('Linha','pmc-themes');  ?> <span class="posted-date port"><?php echo $portfolio['date'][0] ?></span><br>
							<?php } ?>
						</div>
						
						<div class = "project-section">
							<?php if($portfolio['author'][0] !='') {?>
								<!--<i class="fa fa-user"></i>--><?php _e('Garantia','pmc-themes');  ?> <span class="authorp port"><?php echo $portfolio['author'][0] ?></span><br>
							<?php } ?>
						</div>
			...
			<div class = "portnavigation">
				...
				<span><?php next_post_link('%link','<div class="portprev-single">'. __('Anterior','pmc-themes') .'<div class="link-title-next">%title</div></div>',false,''); ?> </span>
				<!-- <span><a href=" <?php echo $pmc_data['portfolio_icon_link'] ?>" class="portfolio-grid"><i class="fa fa-th"></i></a></span> -->
<span><a href="http://fisiopilatesdobrasil.institucional.ws/produtos-2/" class="portfolio-grid"><i class="fa fa-th"></i></a></span>
				<span><?php previous_post_link('%link', '<div class="portnext-single">'. __('Pr&oacute;ximo','pmc-themes') .'<div class="link-title-previous">%title</div></div>' ,false,''); ?> </span>
	...
	<?php endif; ?>
		<div class="portfolio">		
			...
			<h2 class="h3border"><?php _e('Produtos <span>relacionados</span>','pmc-themes'); ?></h2>
