...
class AQ_Product_Block_Feed extends AQ_Block {
	...
	function form($instance) {
		...
		<p class="description note">
			<?php _e('Use this block to create recent product  block.', 'pmc-themes') ?>
		</p>	
	...
	function block($instance) {
		...
		echo do_shortcode( '[recent_products per_page="'.$number_product.'" columns="'.$rows_product.'" product_order="'.$product_order.'" product_sort_by="'.$product_sort_by.'"]' );
	}
